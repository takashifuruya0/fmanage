...
class StockAnalysisData(models.Model):
    ...
    sigma_25 = models.FloatField(verbose_name="標準偏差（25日）")
    ma_25p2sigma = models.FloatField(verbose_name="ボリンジャーバンド+2σ（25日）")
    ma_25m2sigma = models.FloatField(verbose_name="ボリンジャーバンド-2σ（25日）")
